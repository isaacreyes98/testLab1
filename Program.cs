...
Console.WriteLine("Hello, World!");
Console.WriteLine("Isaac Reyes");
Console.WriteLine("Version: {0}", Environment.Version.ToString());

//Completed 1/28/2023

/*
 * Task 2 completed by reyeisaa
 */

int myNum = 20;
Console.WriteLine("Num is now" + myNum);
myNum= 30;
Console.WriteLine("Num is now" + myNum);

string[] sections = { "CPS*3300*01", "CPS*3300*03", "TECH*4982*01" };

Console.WriteLine("The number of sections is " + sections.Length);
...
sections.ToList().ForEach(x => Console.WriteLine(double.E.ToString() + " "));
